...
export interface ApiAlbumAlbum extends Schema.CollectionType {
  ...
  attributes: {
    albumId: Attribute.UID;
    albumTitle: Attribute.String;
...
export interface ApiFavouriteSongFavouriteSong extends Schema.CollectionType {
  collectionName: 'favourite_songs';
  info: {
    singularName: 'favourite-song';
    pluralName: 'favourite-songs';
    displayName: 'FavouriteSong';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSongSong extends Schema.CollectionType {
  ...
  attributes: {
    songTitle: Attribute.String;
    audioFile: Attribute.Media;
    songId: Attribute.UID;
    duration: Attribute.Integer;
    lyrics: Attribute.Text;
    album: Attribute.Relation<'api::song.song', 'oneToOne', 'api::album.album'>;
    playlists: Attribute.Relation<
      'api::song.song',
      'manyToMany',
      'api::playlist.playlist'
    >;
    albumName: Attribute.Relation<
      'api::song.song',
      'manyToOne',
      'api::album.album'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::favourite-song.favourite-song': ApiFavouriteSongFavouriteSong;
